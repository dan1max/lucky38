...
type SpinResult = {
  result: number; color: string; totalBet: number
  totalPayout: number; newBalance: number; outcome: string
}
...
export default function RoulettePage() {
  ...
  async function handleSpin() {
    ...
    setError(''); setSpinning(true); setSpinResult(null)
  ...
  return (
    <GameGuard gameKey="roulette_open">
        ...
        <div style={{ maxWidth: '750px', margin: '0 auto' }}>
          ...
          <div className="panel" style={{ textAlign: 'center', marginBottom: '1.5rem', padding: '2rem' }}>
            <div style={{
              ...
              background: wheelColor, border: '4px solid var(--gold)',
          ...
          <div className="panel" style={{ marginBottom: '1.5rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(13, 1fr)', gap: '3px' }}>
              <div style={{ gridColumn: 'span 1' }}>
                <button onClick={() => addBet('straight', 0, '0')} style={{
              ...
              {Array.from({ length: 36 }, (_, i) => i + 1).map(n => (
                <button key={n} onClick={() => addBet('straight', n, String(n))} style={{
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(6, 1fr)', gap: '0.5rem' }}>
              {OUTSIDE_BETS.map((b, i) => (
                <button key={i} onClick={() => addBet(b.type, b.value, b.label)}
                  className="btn"
                  style={{ fontSize: '0.65rem', padding: '0.5rem 0.2rem', textAlign: 'center', lineHeight: 1.4 }}>
                  {b.label}<br />
